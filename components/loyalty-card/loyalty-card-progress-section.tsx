...
export function LoyaltyCardProgressSection({
  ...
  return (
    <section className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm shadow-slate-200/60 sm:p-5 md:p-6">
      ...
      <div className="mt-3 h-4 w-full overflow-hidden rounded-full bg-slate-200 md:h-5">
        <div
      ...
      <div className="mt-4 grid gap-2 sm:grid-cols-2">
        <p className="rounded-xl border border-slate-100 bg-slate-50 px-3 py-2.5 text-sm font-semibold text-slate-900 sm:text-base">
          {currentPoints} / {targetPoints} points
        </p>
        <p className="rounded-xl border border-amber-100 bg-amber-50 px-3 py-2.5 text-sm font-semibold text-amber-900 sm:text-base">
          {remainingPoints > 0
